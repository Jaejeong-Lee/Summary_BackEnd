...
VALUES
    ('cat1.jpg', '~Desktop\fullstack\upload\board\cat1-1749870568385.jpg', 'image/jpeg',283580, (SELECT MAX(no) FROM tbl_board)),
    ('cat2.jpg', '~Desktop\fullstack\upload\board\cat2-1749870568395.jpg', 'image/jpeg',166577, (SELECT MAX(no) FROM tbl_board)),
    ('cat3.jpg', '~Desktop\fullstack\upload\board\cat3-1749870568401.jpg', 'image/jpeg',119049, (SELECT MAX(no) FROM tbl_board)),
    ('cat4.jpg', '~Desktop\fullstack\upload\board\cat4-1749870568407.jpg', 'image/jpeg',193510, (SELECT MAX(no) FROM tbl_board)),
    ('cat5.jpg', '~Desktop\fullstack\upload\board\cat5-1749870568412.jpg', 'image/jpeg',186751, (SELECT MAX(no) FROM tbl_board));
