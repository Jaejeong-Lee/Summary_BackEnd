...
public class App {
    ...
    private static void deleteOne() {
        ...
        String id = "68355f1064f66e5072d92387";
    ...
    private static void updateOne() {
        // 기존
        String oldId = "68355f1064f66e5072d92386";
        Bson beforeQuery = eq("_id", new ObjectId(oldId));

        // 새 내용
        Bson afterQuery = Updates.set("desc", "Pojo UpdateOne 테스트");

        // 적용
        collection.updateOne(beforeQuery,afterQuery);
    ...
    private static void insertMany() {
        ...
        for (int i = 0; i < 3; i++) {
            todos.add(new Todo(null,"POJO"+i , "POJO insertMany 테스트 " +i, false) );
        }
    ...
    private static void insertOne() {
        Todo newTodo = new Todo(null,"POJO", "POJO 테스트 확인2", false );
        ...
        System.out.println("ID : " + newTodo.getId() + " ===> insert 완료");
    }
}
