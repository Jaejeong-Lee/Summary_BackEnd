...
// +) MySQL에서 JDBCUtil 역할임.
// 'DB 관련 작업 시 공통적인 절차'는 '모듈화'를 통해
// 분리시켜 놓는 것이 추후 수정/삭제 시 용이함.
public class Database {
    ...
    static {
        ...
        // ConnectionString을 사용해서 어느 URL로 접속할 지 정해줌
        // 커넥션을 맺기 위한 URL 작성
        ConnectionString connectionString = new ConnectionString("mongodb://127.0.0.1:27017");
        client = MongoClients.create(connectionString);
//        database = client.getDatabase("todo_db"); // todo_db로 연결시킴
    ...
    public static MongoCollection<Document> getCollection(String colName) {
        ...
        // getCollection 하면 그 주소를 줌.
        return collection;
    }

    // 매핑하면서 todo로 반환받을 수 있어야 하므로 제네릭 형태의 반환을 가능하게 함.
